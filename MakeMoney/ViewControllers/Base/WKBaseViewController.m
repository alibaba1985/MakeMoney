...
- (void)makeBaseProperties
{
    ...
    self.customNavigationBarHeight = CGRectGetHeight([UIApplication sharedApplication].statusBarFrame) + kNavigationBarHeight;
    ...
    // make title
    self.naviBarTitleLabel = [AIViews normalLabelWithFrame:CGRectMake(0, 0, 100, kNavigationBarHeight) text:nil fontSize:20 color:Color_White];
    self.naviBarTitleLabel.textAlignment = NSTextAlignmentCenter;
    self.navigationItem.titleView = self.naviBarTitleLabel;
